...
public class GlobalSymbolTable 
{
	 ...
	 * Modifications: N/A
	 */
	public final void addSymbol(String label, String assemblerAddr, String LinkerAddr, String LengthOfModule) 
	{	
		if(symb.containsKey(label))
		{
			
			System.out.println("Error: duplicate external or program name, teminating");
			System.exit(1);
		}
		else
		{
			ArrayList<Object> value = new ArrayList<Object>();
			value.add(assemblerAddr);
			value.add(LinkerAddr);
			value.add(LengthOfModule);
